...
#pragma warning disable CS1591
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            DatabaseSettings databaseSettings = _configuration.GetSection(nameof(DatabaseSettings)).Get<DatabaseSettings>();
            ...
            IdentitySettings identitySettings = _configuration.GetSection("IdentitySettings").Get<IdentitySettings>();
            _ = services.AddAuthentication(options =>
                ...
                .AddApiKeyInHeaderOrQueryParams("apikey", options =>
                {
                    ...
                    options.Events = new ApiKeyEvents
                    {
                        ...
                        {
                            IdentitySettings identitySettings = _configuration.GetSection(nameof(IdentitySettings)).Get<IdentitySettings>();
                            string apiKey = identitySettings.ApiKey;
        ...
        {
            IApiVersionDescriptionProvider apiVersions = services.BuildServiceProvider().GetRequiredService<IApiVersionDescriptionProvider>();
            foreach (ApiVersionDescription apiVersion in apiVersions.ApiVersionDescriptions)
            {
