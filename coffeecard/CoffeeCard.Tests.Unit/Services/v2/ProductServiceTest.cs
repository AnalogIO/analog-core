...
namespace CoffeeCard.Tests.Unit.Services.v2
{
    public class ProductServiceTest
    {
        ...
        public async Task UpdateProduct_Removes_Omitted_UserGroups()
        {
            ...
            Assert.Collection<ProductUserGroup>(
                result.ProductUserGroup,
            ...
            Assert.DoesNotContain(
                UserGroup.Barista,
                result.ProductUserGroup.Select(e => e.UserGroup)
            );
            Assert.DoesNotContain(
                UserGroup.Manager,
                result.ProductUserGroup.Select(e => e.UserGroup)
        ...
        public async Task GetAllProducts_Returns_Non_Visible_Products()
        {
            ...
            Assert.Collection(result, e => e.Visible.Equals(true), e => e.Visible.Equals(false));
        }
        ...
        public async Task GetAllProducts_Returns_Products_For_All_UserGroups()
        {
            ...
            Assert.Collection<Product>(
                result,
                e =>
                    e.ProductUserGroup = new List<ProductUserGroup>
                    {
                ...
                e =>
                    e.ProductUserGroup = new List<ProductUserGroup>
                    {
                        new ProductUserGroup { UserGroup = UserGroup.Barista }
                    },
                e =>
                    e.ProductUserGroup = new List<ProductUserGroup>
                    {
