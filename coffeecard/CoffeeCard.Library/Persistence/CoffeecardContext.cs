...
namespace CoffeeCard.Library.Persistence
{
    public class CoffeeCardContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            EnumToNumberConverter<UserGroup, int> userGroupIntConverter = new EnumToNumberConverter<UserGroup, int>();
            // Use Enum to String for PurchaseTypes
            EnumToStringConverter<PurchaseType> purchaseTypeStringConverter = new EnumToStringConverter<PurchaseType>();
