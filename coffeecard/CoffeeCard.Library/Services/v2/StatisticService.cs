        ...
        public async Task IncreaseStatisticsBy(int userId, int increaseBy)
        {
            ...
            if (totalStatistics == null)
            {
                totalStatistics = new Statistic
                {
                    ...
                    SwipeCount = user.OwnedTickets.Count(t => t.IsConsumed) - increaseBy,
                    LastSwipe = utcNow
                };
            ...
            if (semesterStatistics == null)
            {
                semesterStatistics = new Statistic
                {
                    ...
                    SwipeCount =
                        user.OwnedTickets.Count(t => t.IsConsumed && t.DateUsed > semesterStart && t.DateUsed < semesterEnd) -
                        increaseBy,
                    LastSwipe = utcNow
                };
            ...
            if (monthStatistics == null)
            {
                monthStatistics = new Statistic
                {
                    ...
                    SwipeCount = user.OwnedTickets.Count(t => t.IsConsumed && t.DateUsed > monthStart && t.DateUsed < monthEnd) -
                                 increaseBy,
                    LastSwipe = utcNow
                };
